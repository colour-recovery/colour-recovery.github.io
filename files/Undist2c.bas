...
LINE INPUT "Enter csv filename? "; DATA$
...
' $ DYNAMIC
DIM csvx(120, 90) AS INTEGER
DIM csvy(120, 90) AS INTEGER
...
IF csvx(x, y) = 120 AND y <> 1 THEN csvx(x, y) = csvx(x + a - 1, y - 1)
IF csvx(x, y) = 120 THEN csvx(x, y) = csvx(x + a - 1, y + 1)
IF x + a = 120 AND csvx(x, y) = 120 THEN
...
IF csvy(x, y) = 120 AND y <> 1 THEN csvy(x, y) = csvy(x + a - 1, y - 1)
...
csvx(x, y) = csvx(x + 1, y)
FOR x = 2 TO 119
csvx(x, y) = INT((csvx(x - 1, y) + csvx(x, y) + csvx(x + 1, y)) / 3)
NEXT x
csvx(x, y) = csvx(x, y)
NEXT y
...
csvy(x, y) = csvy(x, y + 1)
FOR y = 2 TO 89
csvy(x, y) = INT((csvy(x, y - 1) + csvy(x, y) + csvy(x, y + 1)) / 3)
NEXT y
csvy(x, y) = csvy(x, y)
NEXT x
...
OPEN OUTPUT$ FOR OUTPUT AS #2
DIM csv$(4)
DIM x1(120) AS SINGLE
DIM y1(120) AS INTEGER
...
OPEN DATA$ FOR INPUT AS #1
OPEN OUTPUT$ FOR OUTPUT AS #2
DIM d(1920, 2) AS SINGLE
DIM dp(1920) AS SINGLE
DIM x2(1920, 12) AS INTEGER
...
FOR x = 1 TO 1920
FOR a = 1 TO 12
IF a = 1 THEN x2(x, a) = (d(x, 1) + ((d(x, 2) - d(x, 1)) * (a / 12))) * 15
NEXT a
NEXT x
...
FOR x = 1 TO 1920
FOR a = 1 TO 12
x2(x, a) = (dp(x) + ((d(x, 1) - dp(x)) * (a / 12))) * 15
NEXT a
NEXT x
...
FOR x = 1 TO 1920
FOR a = 1 TO 12
x2(x, a) = (d(x, 1) + ((d(x, 2) - d(x, 1)) * (a / 12))) * 15
NEXT a
NEXT x
